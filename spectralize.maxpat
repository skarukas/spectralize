...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2037.0, 979.0, 150.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1070.38037109375, 808.0, 68.0, 22.0 ],
					"text" : "s audio-out"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1533.5, 18.3125, 66.0, 22.0 ],
					"text" : "r audio-out"
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "partial-display.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1070.38037109375, 663.916696548461914, 882.11962890625, 108.916616439819336 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.999998092651367, 623.16668701171875, 910.786302208900452, 108.916615843772888 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1070.38037109375, 625.250028729438782, 97.0, 22.0 ],
					"text" : "route justPitches"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1070.38037109375, 597.5, 72.0, 22.0 ],
					"text" : "r from-script"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 51.0, 96.0, 97.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 51.0, 68.0, 40.0, 22.0 ],
									"text" : "ctlin 1"
								}
...
,
					"patching_rect" : [ 543.44018600000004, 16.0, 42.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 15.3333740234375, 266.0, 68.0, 22.0 ],
									"text" : "s audio-out"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 78.56207275390625, 218.0, 77.0, 22.0 ],
									"text" : "loadmess 90"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 16.22869873046875, 142.03668212890625, 242.0, 35.0 ],
...
,
					"patching_rect" : [ 1454.5, 12.8125, 73.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 118.0, 100.0, 105.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 134.33331298828125, 78.0, 22.0 ],
									"saved_object_attributes" : 									{
										"filename" : "spectralize",
										"parameter_enable" : 0
									}
,
									"text" : "js spectralize"
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 344.5, 21.166671752929688, 25.0, 22.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 459.440185546875, 16.0, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
,
					"patching_rect" : [ 26.83331298828125, 323.78668212890625, 57.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 74.33331298828125, 352.49749755859375, 545.33331298828125, 352.49749755859375 ],
					"source" : [ "obj-95", 1 ]
				}
